...
multipliers = [1,1,1]
approx_ideal = [1.66170782e+03, 6.14280000e+00, 5.23954248e-02]
approx_nadir = [1.68435865e+03, 8.47736006e+00, 2.63255491e-01]
...
def vehicle_crashworthiness(var_iv: np.array = np.array([2, 2, 2, 2, 2])) -> MOProblem:
    ...
    problem = MOProblem(variables=variables, objectives=objectives, ideal=approx_ideal, nadir=approx_nadir)
